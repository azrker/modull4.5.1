...
export default class Dice extends Component {
    ...
    render() {
        return (
            <div className="div">
                <span>______________________press=>space button______________________</span>
                <div className="div1">
                    <p>{this.state.press}</p>
                </div>
                <span>__________________________click=>block___________________________</span>
                <div className="allDiv">
                    <div onClick={this.zer1} className="div1">
                        <p>{this.state.click1}</p>
                    </div>
                    <div onClick={this.zer2} className="div1">
                        <p>{this.state.click2}</p>
                    </div>
                    <div onClick={this.zer3} className="div1">
                        <p>{this.state.click3}</p>
                    </div>
                    <div onClick={this.zer4} className="div1">
